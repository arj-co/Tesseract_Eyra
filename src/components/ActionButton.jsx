  ...
  return (
    <div 
      ...
      className={`w-full rounded-lg font-bold text-center transition-all cursor-pointer ${
        isSpeak 
          ? 'bg-[#0F6E56] text-white hover:bg-[#0B5240] shadow-[0_4px_14px_rgba(15,110,86,0.4)] border border-[#0B5240] animate-pulse-glow hover:scale-[1.02]' 
          : type === 'autofill'
            ? 'bg-gradient-to-r from-[#0F6E56] to-[#1D9E75] text-white hover:opacity-90 shadow-[0_4px_12px_rgba(15,110,86,0.3)] border-0 hover:scale-[1.01]'
